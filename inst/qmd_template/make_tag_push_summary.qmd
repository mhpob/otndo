...
reactable(mt,
          columns = list(
            PIs = colDef(minWidth = 100),
            POC = colDef(minWidth = 100),
...
station_spatial <- station_spatial[, .(station, Detections, Individuals,
...
date_seq[, remaining := sapply(date,
                               function(.){
                                 sum(
                                   between(.,
                                           transmitter_life$first_record,
                                           transmitter_life$last_record) == T
                                 )
                               })]
