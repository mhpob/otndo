...
author: "Created with the [`matos` R package](https://matos.obrien.page)"
---
...
setnames(mt, c('PI', 'POC', 'Project name', 'Network', 'Project code',
               'Detections', 'Individuals', 'PI_emails', 'POC_emails'))
...
```{r results='asis', echo=FALSE}
if(!act_eval & is.null(params$since)){
...
#\ label: new-matches
if(act_eval){
  since_date <- push_log$date[nrow(push_log) - 1]
}
