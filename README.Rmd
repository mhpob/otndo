...
After I'm logged in, I can view the files that I've uploaded to my projects using `list_files`.
...
As is noted above, this package is undergoing a ton of development. If there's something I missed, please [open an issue on GitHub](https://github.com/mhpob/matos/issues) or [email me directly](mailto:obrien@umces.edu).
