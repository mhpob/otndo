...
qual <- qual[, .(collectioncode, datelastmodified, datecollected, trackercode,
...
unqual <- unqual[, .(collectioncode, datelastmodified, datecollected,
...
matched <- matched[, .(collectioncode, datelastmodified, detectedby, station,
